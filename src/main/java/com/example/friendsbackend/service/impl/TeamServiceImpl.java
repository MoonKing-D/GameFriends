...
public class TeamServiceImpl extends ServiceImpl<TeamMapper, Team>
    ...
    private static final String SALT = "gamefriend-d_team";
    private static final String BY_TEAM_IDS = String.format("gamefriend-d:team:getTeamListByTeamIds:%s", "byTeamIds");
    private static final String TEAMS_KEY = String.format("gamefriend-d:team:getTeams:%s", "getTeams");
    @Resource
    ...
    public Boolean joinTeam(JoinTeamRequest joinTeamRequest, User loginUser) {
        ...
        RLock lock = redissonClient.getLock("gamefriend-d:join_team");
